...
<body>
   <main>
 	...
 	<script src="<%=basePath%>include/assets/js/jquery-1.11.1.min.js"></script>
 	<script src="<%=basePath%>include/assets/js/jquery.backstretch.min.js"></script>
    <script src="<%=basePath%>include/js/index.js"></script>

...
<div class="panel panel-info">
	...
	<div style="float:right;padding-right:20px;">
		<a id="a" href="./user/goLogin" style="margin-right:15px;" class="easyui-linkbutton" data-options="iconCls:'icon-redo'">登录</a> <!-- <a id="b"
			href="#">新闻</a> -->
	</div>
	</div>
</div>
	...
	<script src="include/js/jquery.min.js"></script>
    <script src="include/js/myindex.js"></script>
